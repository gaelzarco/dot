...
- Coursework: C++, Data Structures & Algorithms, Python, Linux, Networking,
  SQL Databases, System Design & Analysis, Operating Systems, Discrete
  Mathematics, Calculus

*University of Nevada, Las Vegas* | *Software Development Certificate*
#h(1fr) August 2021 -- June 2022 \
- Coursework: Software Development, HTML/CSS, JavaScript, Python, React, AWS,
...
*Home Lab* | *Self-Hosted Application Platform (Arch Linux, Coolify)* #h(1fr)
  In Progress \
